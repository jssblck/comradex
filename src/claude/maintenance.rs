...
mod tests {
    ...
    fn claude_usage_validates_units_and_shared_windows() {
        let snapshot=parse_usage(br#"{"five_hour":{"utilization":12.1,"resets_at":"2026-09-25T20:00:00Z"},"seven_day":null,"seven_day_opus":{"utilization":100}}"#,100).unwrap();
        assert_eq!(snapshot.windows["5h"].used_percent, Some(13));
